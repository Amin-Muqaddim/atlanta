	...
	function emd_ent_map_tab($app,$active_tab,$shc_list){
		...
		foreach($map_ents as $kent => $myent){
			...
			if(!empty($file_attrs[$kent])){
				foreach($file_attrs[$kent] as $fattr => $fval){
					...
					if(empty($fval['max_file_uploads']) || (!empty($fval['max_file_uploads']) &&  $fval['max_file_uploads'] != 1)){
						...
						echo '<input type="number" class="small-text" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_max_files_' . $fattr . '" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][max_files][' . $fattr . ']" value="' . esc_attr($max_files) . '">';
					...
					echo '<input type="number" class="small-text" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_max_file_size_' . $fattr .'" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][max_file_size][' . $fattr . ']" value="' . esc_attr($max_file_size) . '"> KB';
					...
					echo '<textarea cols="40" rows="5" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_file_exts_' . $fattr . '" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][file_exts][' . $fattr . ']">' . esc_html($file_exts) . '</textarea>';
			...
			if(!empty($comment_list) && !empty($comment_list[$kent])){
				...
				echo '<input type="number" class="small-text" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_comments_per_page" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][comments_per_page]" value="' . esc_attr($per_page_val) . '">';
				echo "</p></td></tr>";
				...
				echo '<input type="number" class="small-text" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_comments_max_files" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][comments_max_files]" value="' . esc_attr($max_files) . '">';
				echo "<p class='description'>" . __('Sets the maximum number of allowable file uploads.','emd-plugins') . "</p></td></tr>";
				...
				echo '<input type="number" class="small-text" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_comments_max_file_size" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][comments_max_file_size]" value="' . esc_attr($max_file_size) . '"> KB';
				$server_size = ini_get('upload_max_filesize');
				if(preg_match('/M$/',$server_size)){
					$server_size = preg_replace('/M$/','',$server_size);
					$server_size = $server_size * 1000;
				...
				echo '<textarea cols="40" rows="5" id="' . esc_attr($app) . '_ent_map_list_' . $kent . '_comments_file_exts" name="' . esc_attr($app) . '_ent_map_list[' . $kent . '][comments_file_exts]">' . esc_html($file_exts) . '</textarea>';
				echo "<p class='description'>" . __('Sets the file extensions allowed to upload. Seperate each extension by a comma. For example: jpg,png,pdf','emd-plugins') . "</p></td></tr>";
			?>
			<script type="text/javascript">
				jQuery(document).ready(function($){
