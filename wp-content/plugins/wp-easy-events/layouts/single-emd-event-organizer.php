...
<div class="notfronteditable">
    <div class="section-wrapper">
        <div style="padding-bottom:10px;clear:both;text-align:right;" id="modified-info-block" class=" modified-info-block">
            <div class="textSmall text-muted modified" style="font-size:75%"><span class="last-modified-text"><?php _e('Last modified', 'wp-easy-events'); ?> </span><span class="last-modified-author"><?php _e('by', 'wp-easy-events'); ?> <?php echo get_the_modified_author(); ?> - </span><span class="last-modified-datetime"><?php echo human_time_diff(strtotime(get_the_modified_date('Y-m-d') . " " . get_the_modified_time('H:i')) , current_time('timestamp')); ?> </span><span class="last-modified-dttext"><?php _e('ago', 'wp-easy-events'); ?></span></div>
        </div>
